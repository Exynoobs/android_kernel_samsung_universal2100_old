...
CC    = $(ANDROID_BUILD_TOP)/prebuilts/clang/host/linux-x86/clang-r383902/bin/clang
LD		= $(CROSS_COMPILE)ld
AR		= $(CROSS_COMPILE)ar
NM		= $(CROSS_COMPILE)nm
...
CLANG_TRIPLE	?= $(ANDROID_BUILD_TOP)/prebuilts/clang/host/linux-x86/clang-r383902/bin/aarch64-linux-gnu-
